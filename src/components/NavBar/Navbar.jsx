...
export default function Navbar() {
  ...
  return (
    <div className="main_navbar">
      ...
      <NavLink exact to="/orders" activeClassName="active_main_navbar_option"><img src='../takeout_dining_FILL0_wght400_GRAD0_opsz48.png' alt="mc_icon" />Pedidos</NavLink>
      ...
      <NavLink to="/checkoutpage"><img src="../shopping_bag.png" alt="shopping_bag" />Carrito</NavLink>
        {userLogged && <button>
